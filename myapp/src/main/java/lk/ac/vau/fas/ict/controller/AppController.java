...
public class AppController {
	...
	@PutMapping("/students/update/{regNo}")
	public Student updateStudent(@PathVariable("regNo") String regNo,@RequestBody Student updateStudent){
		for(Student student:students){
			if(student.getRegNo().equals(regNo)){
	...
	@DeleteMapping("/students/delete/{regNo}")
	public String delelteStudent(@PathVariable("regNo") String regNo){
		for(Student student:students){
			if(student.getRegNo().equals(regNo)){
